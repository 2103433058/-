...
<div class="tool-card">
  ...
  <p style="font-size:0.85rem;margin:8px 0;color:var(--vp-c-text-muted);">Agent 架构 · 多模型后端 · worktree 隔离 · subagent 并行调度 · Hook 自动化。配置国产模型后能力保持度高，<strong style="color:#e8e8e8;">实际工作能力业界最强</strong>。</p>
  <div class="tc-tags">
...
<div class="tool-card">
  ...
  <p style="font-size:0.85rem;margin:8px 0;color:var(--vp-c-text-muted);">一键安装 · 零配置上手 · 交互友好。<strong style="color:#e8e8e8;">入门体验最佳</strong>，但接入第三方模型后推理能力下降明显，工作流逻辑不如 Claude Code 严谨。</p>
  <div class="tc-tags">
...
<div class="tool-card">
  ...
  <p style="font-size:0.85rem;margin:8px 0;color:var(--vp-c-text-muted);">编码 · 文档 · PPT · 数据分析 — <strong style="color:#e8e8e8;">模块化封装 AI 能力</strong>，降低使用门槛。适合企业 AI 转型期团队推广，正在公司内部体验验证。</p>
  <div class="tc-tags">
...
<div class="tool-card">
  ...
  <p style="font-size:0.85rem;margin:8px 0;color:var(--vp-c-text-muted);">深度集成 IDE · 面向专业开发场景。<strong style="color:#e8e8e8;">不适合非技术岗位</strong>，财务等业务人员使用门槛过高。</p>
  <div class="tc-tags">
...
<div style="text-align:center;padding:48px 0 24px;color:var(--vp-c-text-muted);font-size:0.85rem;">
  <p>报告版本 v3.0 · 2026.06.23 · 资金管理部</p>
